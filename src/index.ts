...
export function apply(ctx: Context) {
  ...
  ctx.tools.register(defineTool({
    ...
    async execute(args: ToolArgs, execCtx: any): Promise<ToolResult> {
      ...
      const summary = parseReports(uniqueReportFiles, startedAt - 2000, limits.maxFilters)
      ...
      const reportPaths = args.detailedReport ? uniqueReportFiles.slice(0, 100).map((file) => relative(projectRoot, file)) : []
